...
map("n", "<space>r", "<cmd>lua vim.lsp.buf.references()<CR>", lsp_opts)
...
map("t", "<A-t>", ":ToggleTerm<CR>")
map("n", "v:count1 <A-t>", ":v:count1" .. "\"ToggleTerm\"<CR>")
map("v", "v:count1 <A-t>", ":v:count1" .. "\"ToggleTerm\"<CR>")
